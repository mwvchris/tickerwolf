                ...
                <div class="max-w-xl">
                    ...
                    <div x-data="pages.formValidation.initFormValidationExample" class="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6">
                        <div>
                            ...
                            <span class="text-tiny-plus text-error" x-show="username.blurred && username.errorMessage"
                        ...
                        <div>
                            ...
                            <span class="text-tiny-plus text-error" x-show="email.blurred && email.errorMessage"
                        ...
                        <div>
                            ...
                            <span class="text-tiny-plus text-error" x-show="minmax.blurred && minmax.errorMessage"
                        ...
                        <div>
                            ...
                            <span class="text-tiny-plus text-error" x-show="url.blurred && url.errorMessage"
                        ...
                        <div>
                            ...
                            <span class="text-tiny-plus text-error" x-show="startWith.blurred && startWith.errorMessage"
                        ...
                        <div>
                            ...
                            <span class="text-tiny-plus text-error" x-show="endWith.blurred && endWith.errorMessage"
