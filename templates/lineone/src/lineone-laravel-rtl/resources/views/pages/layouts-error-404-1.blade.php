<x-base-layout title="Error 404 v1">
    ...
    <main
        :style="$store.global.isDarkModeEnabled ? { backgroundImage: `url('/images/illustrations/ufo-bg-dark.svg')` } :
        { backgroundImage: `url('/images/illustrations/ufo-bg.svg')` }"
        class="grid w-full grow grid-cols-1 place-items-center bg-center">
        <div class="max-w-[26rem] text-center">
            <div class="w-full">
                <img class="w-full" x-show="!$store.global.isDarkModeEnabled"
                    src="{{ asset('images/illustrations/ufo.svg') }}" alt="image" />
                <img class="w-full" x-show="$store.global.isDarkModeEnabled"
                    src="{{ asset('images/illustrations/ufo-dark.svg') }}" alt="image" />
            </div>
