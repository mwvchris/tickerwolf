            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5">
                        ...
                        <span class="text-tiny-plus text-slate-400 dark:text-navy-300">This is a help text</span>
                    </div>
                </div>
            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5">
                        ...
                        <span class="text-tiny-plus text-slate-400 dark:text-navy-300">This is a disabled input text</span>
                    </div>
                </div>
