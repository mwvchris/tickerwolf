                ...
                <div class="flex items-center justify-between space-x-3 sm:space-x-5">
                    <div class="flex w-full max-w-lg">
                        <label class="relative flex w-full">
                            <input
                                class="form-input peer h-9 w-full rounded-r-lg bg-white px-3 py-2 shadow-soft ring-primary/50 placeholder:text-slate-400 focus:ring-3 dark:bg-navy-700 dark:shadow-none dark:ring-accent/50 dark:placeholder:text-navy-300 lg:pr-9"
