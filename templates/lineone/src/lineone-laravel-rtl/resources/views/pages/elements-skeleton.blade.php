                        ...
                        <div class="flex flex-col border border-slate-150 dark:border-navy-500">
                            <div class="flex space-x-5 px-5 py-4">
                                ...
                                <div class="flex flex-1 flex-col justify-between py-2">
                                    <div class="skeleton animate-wave h-3 w-full rounded-sm bg-slate-150 dark:bg-navy-500">
                                    </div>
                                    <div class="skeleton animate-wave h-3 w-full rounded-sm bg-slate-150 dark:bg-navy-500">
                                    </div>
                                </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex space-x-5 py-4">
                                ...
                                <div class="flex flex-1 flex-col justify-between py-2">
                                    ...
                                    <div class="skeleton animate-wave h-6 w-full rounded-sm bg-slate-150 dark:bg-navy-500">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-5 max-w-md">
                        <div class="flex flex-col space-y-4 border border-slate-150 dark:border-navy-500">
                            ...
                            <div class="flex flex-1 flex-col justify-between space-y-4 p-4">
                                <div class="skeleton animate-wave h-4 w-9/12 rounded-sm bg-slate-150 dark:bg-navy-500">
                                </div>
                                <div class="skeleton animate-wave h-4 w-6/12 rounded-sm bg-slate-150 dark:bg-navy-500">
                                </div>
                                <div class="skeleton animate-wave h-4 w-full rounded-sm bg-slate-150 dark:bg-navy-500">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 max-w-md">
                        <div class="flex animate-pulse flex-col border border-slate-150 dark:border-navy-500">
                            <div class="flex space-x-5 px-5 py-4">
                                ...
                                <div class="flex flex-1 flex-col justify-between py-2">
                                    <div class="h-3 w-full rounded-sm bg-slate-150 dark:bg-navy-500"></div>
                                    <div class="h-3 w-full rounded-sm bg-slate-150 dark:bg-navy-500"></div>
                                </div>
                            </div>
                            ...
                            <div class="w-full px-6 py-4">
                                <div class="h-3 w-full rounded-sm bg-slate-150 dark:bg-navy-500"></div>
                                <div class="mt-4 h-3 w-8/12 rounded-sm bg-slate-150 dark:bg-navy-500"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mt-5 max-w-md">
                        <div class="flex animate-pulse flex-col">
                            ...
                            <div class="flex space-x-5 py-4">
                                <div class="size-16 rounded-full bg-slate-150 dark:bg-navy-500"></div>
                                <div class="flex flex-1 flex-col justify-between py-2">
                                    <div class="h-3 w-10/12 rounded-sm bg-slate-150 dark:bg-navy-500"></div>
                                    <div class="h-6 w-full rounded-sm bg-slate-150 dark:bg-navy-500"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="max-w-2xl">
                    ...
                    <div class="mt-5 max-w-md">
                        <div
                            ...
                            <div class="h-48 w-full bg-slate-150 dark:bg-navy-500"></div>
                            <div class="flex flex-1 flex-col justify-between space-y-4 p-4">
                                <div class="h-4 w-9/12 rounded-sm bg-slate-150 dark:bg-navy-500"></div>
                                <div class="h-4 w-6/12 rounded-sm bg-slate-150 dark:bg-navy-500"></div>
                                <div class="h-4 w-full rounded-sm bg-slate-150 dark:bg-navy-500"></div>
                            </div>
                        </div>
                    </div>
                </div>
