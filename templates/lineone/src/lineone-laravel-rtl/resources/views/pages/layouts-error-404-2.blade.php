    ...
    <main class="grid w-full grow grid-cols-1 place-items-center">
        <div class="grid max-w-(--breakpoint-lg) grid-cols-1 place-items-center gap-12 p-6 lg:grid-cols-2 lg:gap-24">
            <div class="absolute p-6 opacity-20 lg:static lg:opacity-100">
                <img width="440" x-show="!$store.global.isDarkModeEnabled"
                    src="{{ asset('images/illustrations/penguins.svg') }}" alt="404 image" />
                <img width="440" x-show="$store.global.isDarkModeEnabled"
                    src="{{ asset('images/illustrations/penguins-dark.svg') }}" alt="404 image" />
            </div>
