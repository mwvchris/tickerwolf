    ...
    <main x-data="{ isShowChatInfo: !$store.breakpoints.mdAndDown, activeChat: { chatId: 'chat-1', name: 'Alfredo Elliott', avatar_url: '/images/200x200.png' } }" x-effect="$store.breakpoints.mdAndDown === true && (isShowChatInfo = false)"
        ...
        <div
            ...
            <div class="flex items-center  space-x-5">
                <div class="ml-1 size-7">
                    <button
                        class="menu-toggle cursor-pointer mr-0.5 flex size-7 flex-col justify-center space-y-1.5 text-primary outline-hidden focus:outline-hidden dark:text-accent-light/80"
        ...
        <div :class="$store.breakpoints.smAndUp && 'scrollbar-sm'"
            ...
            <div x-show="activeChat.chatId === 'chat-1'" x-transition:enter="transition-all duration-500 easy-in-out"
                ...
                <div class="flex items-start  space-x-2.5 sm:sm:space-x-5">
                    <div class="avatar">
                        <img class="rounded-full" src="null" :src="activeChat.avatar_url" alt="avatar" />
                    </div>
                    ...
                    <div class="flex flex-col items-start space-y-3.5">
                        <div class="ml-4 max-w-lg sm:ml-10">
                            <div
                                class="rounded-2xl rounded-tr-none bg-white p-3 text-slate-700 shadow-xs dark:bg-navy-700 dark:text-navy-100">
                ...
                <div class="flex items-start justify-end  space-x-2.5 sm:sm:space-x-5">
                    <div class="flex flex-col items-end space-y-3.5">
                        <div class="mr-4 max-w-lg sm:mr-10">
                            <div
                                class="rounded-2xl rounded-tl-none bg-info/10 p-3 text-slate-700 shadow-xs dark:bg-accent dark:text-white">
