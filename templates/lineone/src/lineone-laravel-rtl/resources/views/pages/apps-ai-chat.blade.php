    ...
    <main class="main-content chat-app h-100vh mt-0 flex flex-col w-full min-w-0 supports-[height:1dvh]:h-dvh">
        <div
                    ...
                    <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                        <div
                            ...
                            <ul>
                                <li>
                                    <a href="#"
                                        class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-hidden transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">ChatGPT
                                        3</a>
                                </li>
                                <li>
                                    <a href="#"
                                ...
                                <li>
                                    <a href="#"
                                        class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-hidden transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Copilot</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="flex h-8 items-center px-3 pl-8 font-medium tracking-wide outline-hidden transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Copilot
                                        Pro</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="flex space-x-3 items-center">
                ...
                <button
                    class="btn space-x-2 bg-linear-to-r from-green-400 to-blue-600 font-medium text-white">
