            ...
            <div class="card col-span-12 pb-4">
                <div class="mt-3 flex items-center justify-between px-4 sm:px-5">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <select
                            class="form-select h-8 rounded-full border border-slate-300 bg-white px-2.5 pl-9 text-xs-plus hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
